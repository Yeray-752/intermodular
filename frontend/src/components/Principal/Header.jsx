                        ...
                        <div className="flex items-center justify-between h-20">
                            <div onClick={() => navigate('/')} className="flex items-center space-x-4 cursor-pointer group">
                                ...
                                <div className="hidden sm:block">
                                    ...
                                    <p className="text-xs text-base-100">{t('subtitle')}</p>
                                </div>
                            </div>
                            ...
                            <nav className="hidden md:flex items-center space-x-4">
                                ...
                                <label className="swap swap-rotate mx-2">
                                    <input type="checkbox" checked={theme === "synthwave"} onChange={(e) => setTheme(e.target.checked ? "synthwave" : "vibrant-light")} />
                                ...
                                {user ? (
                                    ...
                                    <button onClick={() => navigate('/login')} className="btn btn-primary text-base-100 btn-md rounded-xl font-bold">
                                        {t('nav.login')}
                                    </button>
                                )}
                            </nav>
