                ...
                <div className="border-t border-base-300 pt-8 text-base-content/70 text-sm">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <p>
                            ...
                            <span className="text-primary font-medium ml-1">Yeray Carrión</span> & 
                            <span className="text-primary font-medium ml-1">Óscar Gordillo</span>
                        </p>
                        <div className="flex items-center gap-6">
                            {/* Enlaces al namespace 'legales' */}
                            <button onClick={() => navigate('/Aviso-legal')} className="hover:text-primary transition-colors">
                                {t('legales:privacy')}
                            </button>
                            <button onClick={() => navigate('/Aviso-legal')} className="hover:text-primary transition-colors">
                                {t('legales:terms')}
